...
am2r_regions: Dict[str, Set[str]] = {
    ...
    "A3M04_M": {"A3M04_L", "A3M04_R"},

    "A3M05_M": {"A3M05_R"},

    "A3M06_M": {"A3M06_L", "A3M06_D"},

    "A3M07_M": {"A3M07_L", "A3M07_R", "A3M07_U"},

    "A3M08_M": {"A3M08_L", "A3M08_R"},

    "A3M09_M": {"A3M09_R"},

    "A3M10_M": {"A3M10_L", "A3M10_R"},

    "A3M11_M": {"A3M11_L", "A3M11_R"},

    "A3M12_M": {"A3M12_BL", "A3M12_R", "A3M12_TL"},

    "A3M13_M": {"A3M13_L", "A3M13_R"},

    "A3M14_M": {"A3M14_R"},

    "A3M15_M": {"A3M15_TL", "A3M15_L", "A3M15_BL"},

    "A3M16_M": {"A3M16_L", "A3M16_R"},

    "A3M17_M": {"A3M17_L", "A3M17_R"},

    "A3M18_M": {"A3M18_L", "A3M18_TR", "A3M18_BR"},

    "A3M19_M": {"A3M19_L", "A3M19_R"},

    "A3M20_M": {"A3M20_L", "A3M20_D"},

    "A3M21_M": {"A3M21_L", "A3M21_U"},

    "A3M22_M": {"A3M22_R"},

    "A3M23_M": {"A3M23_TR", "A3M23_BR"},

    "A3M24_M": {"A3M24_L", "A3M24_R"},

    "A3M25_M": {"A3M25_L"},

    "A3M26_M": {"A3M26_L", "A3M26_R"},

    "A3B01_M": {"A3B01_U", "A3B01_R"},

    "A3B02_M": {"A3B02_U", "A3B02_R", "A3B02_BR"},

    "A3B03_M": {"A3B03_L", "A3B03_R"},

    "A3B04_M": {"A3B04_L", "A3B04_U"},

    "A3B05_M": {"A3B05_R", "A3B05_D"},

    "A3B06_M": {"A3B06_L"},

    "A3B07_M": {"A3B07_L", "A3B07_R"},

    "A3B08_M": {"A3B08_L", "A3B08_R"},

    "A3B09_M": {"A3B09_L", "A3B09_R"},

    "A3B10_M": {"A3B10_TL", "A3B10_BR"},
